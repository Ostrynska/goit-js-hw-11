...
var _loadingBtn = require("./js/loadingBtn");
const refs = {
...
(0, _loadingBtn.onScroll)();
(0, _loadingBtn.onScrollToTopBtn)();
function onFormSearch(e) {
    ...
    if (searchImgName === "") {
        (0, _notiflixDefault.default).Notify.failure("Please enter a search term in the search box.");
        return;
    }
    (0, _fetchImages.fetchImages)(searchImgName, page).then(({ data  })=>{
        if (data.totalHits === 0) (0, _notiflixDefault.default).Notify.failure("Sorry, there are no images matching your search query. Please try again.");
            ...
            (0, _renderGallery.renderGallery)(data.hits);
            (0, _notiflixDefault.default).Notify.success(`Hooray! We found ${data.totalHits} images.`);
            if (data.totalHits > 40) refs.loadMoreBtn.classList.remove("is-hidden");
        }
...
},{"./css/styles.css":"1CY4s","notiflix":"5WWYd","./js/fetchImages":"dOg5x","./js/renderGallery":"795fs","./js/loadingBtn":"jlaRz","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1CY4s":[function() {},{}],"5WWYd":[function(require,module,exports) {
var global = arguments[3];
...
},{}],"dOg5x":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"./../utils.js":"5By4s","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"795fs":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function renderGallery(images) {
    ...
    let simpleLightbox = new (0, _simplelightboxDefault.default)(".gallery a").refresh();
}

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","simplelightbox":"9ydBq","simplelightbox/dist/simple-lightbox.min.css":"kaxSc"}],"9ydBq":[function(require,module,exports) {
/*!
...
},{}],"kaxSc":[function() {},{}],"jlaRz":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "onScroll", ()=>onScroll);
parcelHelpers.export(exports, "onScrollToTopBtn", ()=>onScrollToTopBtn);
...
function onScroll() {
    ...
    if (scrolled > coords) btnToTop.classList.add("btn-to-top--visible");
    if (scrolled < coords) btnToTop.classList.remove("btn-to-top--visible");
}
